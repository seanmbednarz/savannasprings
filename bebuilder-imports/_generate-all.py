...
pages["financing"]=[section(merge(navy(HERO_BLOB),pad(54,56)),[W("1/1",nz(fin_hero,HERO_BLOBS))]),section(pad(78,78),[W("1/3",tiercard(*t)) for t in tiers]+[W("1/3",apply)])]
# ---- GALLERY ----
...
gs=[section(merge(navy(HERO_BLOB),pad(54,56)),[W("1/1",nz(gal_hero,HERO_BLOBS))])]
...
pages["reviews"]=[section(merge(navy(HERO_BLOB),pad(54,56)),[W("1/1",nz(rv_hero,HERO_BLOBS))]),section(pad(78,40),[W("1/3",reviewcard(*r)) for r in revs6]),section(pad(0,78),[W("1/1",elf)]),FWT()]
...
pages["faq"]=[section(merge(navy(HERO_BLOB),pad(54,56)),[W("1/1",nz(faq_hero,HERO_BLOBS))]),section(pad(64,24),[W("1/1",faq_body)]),section(pad(0,64),[W("1/1",faq_cta)])]
# ---- HOME ----
...
pages["home"]=[
 section(merge(bg(NAVY),bg_image(HIMG,pos="right 30%"),overlay(),pad(70,78)),[W("1/1",'<div style="max-width:600px">'+h_hero_left+'</div>')]),
