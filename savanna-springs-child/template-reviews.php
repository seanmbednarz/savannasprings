...
<section class="ss-band-navy">
	...
	<div class="ss-wrap" style="padding-top:54px;padding-bottom:56px;text-align:center;position:relative">
		<div class="ss-eyebrow is-dark" style="margin-bottom:12px">Reviews</div>
		<h1 style="font-weight:800;font-size:48px;color:#fff;letter-spacing:-.025em">What our neighbors say</h1>
		<p style="font-size:18px;color:var(--spring-100);max-width:600px;margin:16px auto 0;line-height:1.6">Real homeowners across the Mahoning Valley and Western PA. We let our work — and our customers — do the talking.</p>
	</div>
</section>
...
<section class="ss-wrap ss-section">
	...
	<!-- Elfsight live Google reviews slot (paste widget embed here in production) -->
	<div class="ss-card" style="margin-top:34px;text-align:center;padding:40px">
		<h2 style="font-size:24px;margin-bottom:8px">See all our Google reviews</h2>
		<p style="color:var(--text-body);margin-bottom:20px">Drop your Elfsight Google Reviews widget here to show live, up-to-date ratings.</p>
		<!-- Elfsight Google Reviews | placeholder -->
		<div class="elfsight-app-placeholder" style="color:var(--text-muted);font-family:var(--font-display);font-weight:600">[ Elfsight reviews widget ]</div>
	</div>
</section>
