...
add_action( 'acf/init', function () {
	...
	acf_add_local_field_group( array(
		...
		'fields' => array(
			...
			array( 'key' => 'f_p_eyebrow', 'label' => 'Eyebrow', 'name' => 'eyebrow', 'type' => 'text', 'instructions' => 'Small label above the headline.' ),
			array( 'key' => 'f_p_h1', 'label' => 'Hero headline (H1)', 'name' => 'h1', 'type' => 'text' ),
			array( 'key' => 'f_p_lead', 'label' => 'Hero lead', 'name' => 'lead', 'type' => 'textarea', 'rows' => 3, 'instructions' => 'The intro sentence under the headline.' ),
			array( 'key' => 'f_p_tab_problem', 'label' => 'Problem & cause', 'type' => 'tab', 'placement' => 'top' ),
			...
			array( 'key' => 'f_p_tab_fix', 'label' => 'How we fix it', 'type' => 'tab', 'placement' => 'top' ),
			array( 'key' => 'f_p_steps', 'label' => 'Diagnose / Recommend / Install steps', 'name' => 'steps', 'type' => 'repeater', 'layout' => 'block', 'button_label' => 'Add step', 'instructions' => 'The 3-step "how it works" row.', 'sub_fields' => array(
			...
			array( 'key' => 'f_p_tab_more', 'label' => 'Payoff & related', 'type' => 'tab', 'placement' => 'top' ),
			array( 'key' => 'f_p_payoff_en', 'label' => 'Show payoff stats?', 'name' => 'payoff_enable', 'type' => 'true_false', 'ui' => 1, 'instructions' => 'Toggle the stats band on this page.' ),
	...
	acf_add_local_field_group( array(
		...
		'fields' => array(
			...
			array( 'key' => 'f_pr_leadform', 'label' => 'Lead form', 'name' => 'lead_form', 'type' => 'select', 'choices' => array( 'water' => 'Free water test (default)', 'salt' => 'Salt delivery (address + bags)', 'delivery' => 'Water delivery (address + products)', 'order' => 'Order water products', 'quote' => 'Quick quote (questionnaire)', 'specials' => 'Specials request' ), 'default_value' => 'water', 'instructions' => 'Which form shows in the bottom CTA section of this product page.' ),
			...
			array( 'key' => 'f_pr_tab_models', 'label' => 'Models', 'type' => 'tab', 'placement' => 'top' ),
			array( 'key' => 'f_pr_models', 'label' => 'Models', 'name' => 'models', 'type' => 'repeater', 'layout' => 'block', 'button_label' => 'Add model', 'instructions' => 'The product/model cards on this page.', 'sub_fields' => array(
			...
			array( 'key' => 'f_pr_tab_related', 'label' => 'Related', 'type' => 'tab', 'placement' => 'top' ),
			array( 'key' => 'f_pr_solves', 'label' => 'Problems this solves', 'name' => 'solves', 'type' => 'relationship', 'post_type' => array( 'ss_problem' ), 'filters' => array( 'search' ), 'return_format' => 'object', 'instructions' => 'Links shown in the "problems this solves" section.' ),
	...
	acf_add_local_field_group( array(
		...
		'fields' => array(
			...
			array( 'key' => 'f_c_type', 'label' => 'Water type', 'name' => 'type', 'type' => 'select', 'choices' => array( 'municipal' => 'Municipal', 'well' => 'Well', 'mixed' => 'Mixed' ), 'instructions' => 'Drives which services are auto-suggested.' ),
			array( 'key' => 'f_c_tab_hero', 'label' => 'Hero & context', 'type' => 'tab', 'placement' => 'top' ),
			...
			array( 'key' => 'f_c_context', 'label' => 'Local context paragraph', 'name' => 'context', 'type' => 'textarea', 'rows' => 4, 'instructions' => 'The localized "about the water here" paragraph.' ),
			array( 'key' => 'f_c_tab_details', 'label' => 'Local details', 'type' => 'tab', 'placement' => 'top' ),
...
add_action( 'acf/init', function () {
	...
	acf_add_local_field_group( array(
		...
		'fields' => array_merge( ss_acf_hero( 'about' ), array(
			...
			array( 'key' => 'f_about_story_photo', 'label' => 'Story photo (optional)', 'name' => 'about_story_photo', 'type' => 'image', 'return_format' => 'url', 'instructions' => 'Optional — shows a photo beside the story (fills the column height). When empty, a stats card shows there instead.' ),
...
add_action( 'acf/init', function () {
	...
	acf_add_local_field_group( array(
		...
		'fields' => array(
			...
			array( 'key' => 'f_hero_focus', 'label' => 'Hero photo position', 'name' => 'hero_focus', 'type' => 'select', 'allow_null' => 1,
				'choices' => array(
					'center_center' => 'Center Center', 'center_left' => 'Center Left', 'center_right' => 'Center Right',
					'top_left' => 'Top Left', 'top_right' => 'Top Right', 'top_center' => 'Top Center',
					'bottom_left' => 'Bottom Left', 'bottom_right' => 'Bottom Right', 'bottom_center' => 'Bottom Center',
					'custom' => 'Custom',
				),
				'instructions' => 'Which part of the photo to keep in view. Leave blank for the default framing.' ),
			array( 'key' => 'f_hero_focus_custom', 'label' => 'Custom position', 'name' => 'hero_focus_custom', 'type' => 'text',
				'instructions' => 'A CSS background-position value, e.g. "70% 30%" or "right 20%".', 'placeholder' => '70% 30%',
				'conditional_logic' => array( array( array( 'field' => 'f_hero_focus', 'operator' => '==', 'value' => 'custom' ) ) ) ),
			array( 'key' => 'f_hero_size', 'label' => 'Hero photo size', 'name' => 'hero_size', 'type' => 'select', 'allow_null' => 1,
				'choices' => array(
					'auto' => 'Auto', 'contain' => 'Contain', 'cover' => 'Cover',
					'cover_uw' => 'Cover, on ultrawide screens only > 1920px', 'custom' => 'Custom',
				),
				'instructions' => 'How the photo fills the hero. Leave blank for the default (Cover).' ),
			array( 'key' => 'f_hero_size_custom', 'label' => 'Custom size', 'name' => 'hero_size_custom', 'type' => 'text',
				'instructions' => 'A CSS background-size value, e.g. "cover", "100% auto" or "1200px".', 'placeholder' => 'cover',
				'conditional_logic' => array( array( array( 'field' => 'f_hero_size', 'operator' => '==', 'value' => 'custom' ) ) ) ),
		),
		'position' => 'side',
		'location' => array(
