...
// The homepage always renders from this coded, ACF-driven template — no
// BeBuilder dependency, so theme updates can't blank it out. (About and
// Gallery keep their BeBuilder toggle in their own templates.)
get_header();
